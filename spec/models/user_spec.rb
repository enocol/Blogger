...
RSpec.describe User, type: :model do
  ...
  describe 'Helper Methods' do
    ...
    it 'returns the 3 most recent posts' do
      ...
      post1 = Post.create(author_id: user.id, title: "title", text: 'This is a post')
      post2 = Post.create(author_id: user.id, title: "title", text: 'This is a post')
      post3 = Post.create(author_id: user.id, title: "title", text: 'This is a post')
